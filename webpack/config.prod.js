...
module.exports={
    ...
    //entrada
    entry: './src/index.js',
    mode: 'production',//permite que la terminal sólo se ponga: npx webpack y al ejecutar, se obtiene. 
    ...
    optimization: {
        ...
        minimizer: [
            new TerserPlugin({
                extractComments: true//extrae los comentarios
            }),
            new CssMinimizerPlugin()//minimiza el css para que al navegador no le cueste trabajo
        ]
    }
}